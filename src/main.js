...
import { faMugHot, faMoon, faLightbulb, faSearch, faGraduationCap, faBookOpen } from "@fortawesome/free-solid-svg-icons";
import { faGithub, faTwitter, faLinkedin, faGithubAlt, faLinkedinIn } from "@fortawesome/free-brands-svg-icons";
import { FontAwesomeIcon } from "@fortawesome/vue-fontawesome";
import Vuex from 'vuex';

library.add(faMugHot, faMoon, faLightbulb, faTwitter, faGithubAlt, faLinkedinIn, faSearch, faGraduationCap, faBookOpen)
